	...
	IN RTMP_ADAPTER *pAd)
{
	...
	{
		printk("RTUSBBssBeaconStop pBeaconSync is NULL\n");
	}
}
...
/*	LARGE_INTEGER 	tsfTime, deltaTime;*/
	...
	{
		printk("RTUSBBssBeaconStart pBeaconSync is NULL\n");
	}
}
	...
	IN RTMP_ADAPTER *pAd)
{
	...
	int i, j;
	UINT8 TXWISize = pAd->chipCap.TXWISize;
	printk("enter RTUSBBssBeaconInit\n");
	...
	{
		for(i=0 ;i<100;i++)
			DBGPRINT(RT_DEBUG_ERROR, ("RTUSBBssBeaconInit fail(%d)\n",i));
		goto error1;
	}
	return;
